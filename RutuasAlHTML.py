...
#RUTAS DE HTML APARTADO ENTRENAMIENTO JUGADORES

BOTON_VER_ANUNCIO_JUGADORES_ENTRENANDO = "//div[contains(@class, 'training-panel-footer center')]//button[contains(@class, 'btn-new center')]"
BOTON_COMPLETE_DE_LOS_ENTRENAMIENTOS = "//button[contains(@class, 'btn-new btn-success btn-show-result')]//span[contains(text(), 'Complete')]"

BOTON_START_PONER_JUGADOR_A_ENTRENAR = "//button[contains(@class, 'btn-new btn-primary')]//span[contains(text(), 'Start')]"
